...
Topik: Perancangan Sistem Agri-POS Menggunakan UML dan Penerapan Prinsip SOLID
...
## Tujuan
1. Mengidentifikasi kebutuhan fungsional dan non-fungsional sistem ke dalam model UML yang tepat.

2. Membuat dan menjelaskan Use Case Diagram, Activity Diagram, Sequence Diagram, dan Class Diagram secara konsisten.

3. Memahami serta menjelaskan penerapan prinsip SOLID dalam desain sistem.

4. Merancang struktur class yang modular, reusable, dan extensible sesuai praktik rekayasa perangkat lunak yang baik.

5. Menunjukkan keterkaitan antara kebutuhan sistem, diagram UML, dan prinsip SOLID dalam sebuah laporan desain.
...
## diagram
![alt text](<docs png/usecase.png>)
![alt text](<docs png/sequence.png>)
![alt text](<docs png/class.png>)
![alt text](<docs png/activity.png>)

---
## Kesimpulan
Keunggulan Sistem

Desain Agri-POS yang dirancang memiliki struktur yang sangat modular berkat penggunaan Packages dan penerapan SOLID. Pemisahan antara logika bisnis (Service), data (Model), dan akses data (Repository) membuat sistem ini mudah dipahami oleh tim pengembang dan mudah untuk dilakukan Unit Testing. Potensi Pengembangan

Sistem ini masih dapat dikembangkan lebih lanjut, antara lain:
1. Interface User (GUI): Mengimplementasikan desain Class Diagram ke dalam JavaFX atau Web-based frontend.
2. Database Nyata: Mengganti mock repository dengan koneksi PostgreSQL atau MySQL yang sesungguhnya.
3. Laporan Dinamis: Menambahkan Strategy Pattern untuk berbagai jenis ekspor laporan (PDF, Excel, CSV).
---
